...
Set gobjMyFile = gobjFso.OpenTextFile(gstrRelativePath & "\supportLibrariesQCIntegration\ReportClasses.vbs", 1)	' 1 - For Reading
Execute gobjMyFile.ReadAll()

Set gobjMyFile = gobjFso.OpenTextFile(gstrRelativePath & "\supportLibrariesQCIntegration\ReportTypeClasses.vbs", 1)
Execute gobjMyFile.ReadAll()

Set gobjMyFile = gobjFso.OpenTextFile(gstrRelativePath & "\supportLibrariesQCIntegration\ExcelDataAccess.vbs", 1)
Execute gobjMyFile.ReadAll()

Set gobjMyFile = gobjFso.OpenTextFile(gstrRelativePath & "\supportLibrariesQCIntegration\GeneralUtility.vbs", 1)
Execute gobjMyFile.ReadAll()

Set gobjMyFile = gobjFso.OpenTextFile(gstrRelativePath & "\supportLibrariesQCIntegration\TestParameters.vbs", 1)
Execute gobjMyFile.ReadAll()

Set gobjMyFile = gobjFso.OpenTextFile(gstrRelativePath & "\supportLibrariesQCIntegration\FrameworkParameters.vbs", 1)
Execute gobjMyFile.ReadAll()

Set gobjMyFile = gobjFso.OpenTextFile(gstrRelativePath & "\supportLibrariesQCIntegration\Settings_Java.vbs", 1)
Execute gobjMyFile.ReadAll()
...
Class Allocator
	...
	Public Sub SetRelativePath()
		...
		'gstrRelativePath = objFso.GetParentFolderName(WScript.ScriptFullName)
		gobjFrameworkParameters.RelativePath =gstrRelativePath
		Set objFso = Nothing
	End Sub
	'###################################################################################################################
